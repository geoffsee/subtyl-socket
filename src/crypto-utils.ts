import { createHash, createHmac, randomBytes, createCipher, createDecipher, createCipheriv, createDecipheriv } from "crypto";
 ...
 */
export function decrypt(encryptedData: string, encryptionKey: Buffer, authenticationKey: Buffer): string {
